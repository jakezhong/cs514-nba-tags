...
public class ListPersonsByUserServlet extends HttpServlet {

  @Override
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
    PersonDao dao = (PersonDao) this.getServletContext().getAttribute("dao-person");
    String startCursor = req.getParameter("cursor-person");
    ...
    req.getSession().setAttribute("cursor-person", endCursor);
    req.getSession().setAttribute("page", "list-persons");

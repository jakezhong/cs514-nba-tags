...
public class ListGroupServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //the app uses Cloud storage to store binary data, such as pictures in this case
        // The app continues to use Cloud datastore for book information
        ...
        switch (storageType) {
            ...
            case "cloudsql":
                try {
                    ...
                    daoGroup = new CloudSqlGroupDao(connect);

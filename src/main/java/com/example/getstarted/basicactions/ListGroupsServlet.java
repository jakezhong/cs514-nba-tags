...
public class ListGroupsServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    switch (storageType) {
      ...
      case "cloudsql":
        try {
          ...
          dao = new CloudSqlGroupDao(connect);
    ...
    this.getServletContext().setAttribute("dao-group", dao);
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
    ...
    req.setAttribute("cursor-group", endCursor);
    req.setAttribute("page", "list-groups");

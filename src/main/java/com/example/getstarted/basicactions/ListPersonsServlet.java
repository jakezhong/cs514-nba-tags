...
import com.example.getstarted.daos.CloudSqPersonlDao;
import com.example.getstarted.daos.PersonDataStoreDao;
...
public class ListPersonsServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    switch (storageType) {
      ...
      case "cloudsql":
        try {
          ...
          dao = new CloudSqPersonlDao(connect);
    ...
    this.getServletContext().setAttribute("dao-person", dao);
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException,
    ...
    req.setAttribute("page", "list-persons");

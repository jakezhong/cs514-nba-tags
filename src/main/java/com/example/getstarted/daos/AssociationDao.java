...
public interface AssociationDao {
  ...
  Result<Association> listPersonsByGroup(String groupId) throws SQLException;
//
//  Result<Association> listGroups(String GroupId, String startCursor) throws SQLException;
}
// [END example]
